...
\033[1;39m     ┏━━━━━━━━━━━━━━━━━━━\033[38;5;46mRASEL\033[1;39m━━━━━━━━━━━━━━━━━━━━┓
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\033[1;34m        : [★]RASEL\033[1;39m         ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[1;34m    : [★]MD RASEL MIAH\033[1;39m         ┃
...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋\033[1;34m    : [★]+𝟴𝟴𝟬𝟭941223322\033[1;39m     ┃
...
try:
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m JOIN THE VIRUS CRUSH HOUSE PUBLIC GROUP...')
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m NOTE : ENJOY KORUN SOBAI..')
    ...
    update = ('5.2')
    if str(v) in update:
        os.system('xdg-open https://www.facebook.com/groups/realajairagroup/')
    else:pass
...
def new(uid,pwx,tl):
    ...
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="114.0.5651.225", "Google Chrome";v="114.0.5651.225"',
    'sec-ch-ua-mobile': '?0',
    ...
    'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5651.225 Safari/537.36',
    'viewport-width': '980',}
